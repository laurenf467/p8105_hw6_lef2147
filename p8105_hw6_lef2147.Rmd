...
The RMSE for model 1 and model 2 have significant bimodalality going on. Model three has a lower RMSE but it has a more constant RMSE. Based on this, adjusted R squared values, and significance of the variables in the model, we can conclude that Model 3 is the best predictive model. 
...
```
The 95% confidence interval for r squared value is (-0.239, 2.062) and the 95% confidence interval for log(beta1*beta0) is (-0.583, 2.332). 
